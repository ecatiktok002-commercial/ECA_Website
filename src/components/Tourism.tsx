        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
          <div className="md:col-span-2 relative rounded-2xl overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex flex-col justify-end p-8">
              <h3 className="text-white text-3xl font-bold mb-2">Sustainable Destinations</h3>
              <p className="text-emerald-50/80 max-w-md">
                Integrating hospitality with environmental stewardship in iconic locations.
              </p>
            </div>
          </div>
          <div className="relative rounded-2xl overflow-hidden group">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex flex-col justify-end p-8">
              <h3 className="text-white text-2xl font-bold mb-2">Business Concierge</h3>
              <p className="text-emerald-50/80">Tailored corporate mobility and luxury stays.</p>
            </div>
          </div>
          <div className="relative rounded-2xl overflow-hidden group">
            <img
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex flex-col justify-end p-8">
              <h3 className="text-white text-2xl font-bold mb-2">Coastal Assets</h3>
              <p className="text-emerald-50/80">Strategic acquisition of prime maritime real estate.</p>
            </div>
          </div>
          <div className="md:col-span-2 bg-primary p-12 rounded-2xl flex flex-col justify-center">
            ...
            <p className="text-emerald-100/70 text-lg mb-8 max-w-xl">
              Our tourism division leverages ECA’s logistical expertise to create seamless, high-end travel ecosystems that prioritize both guest comfort and ecological balance. Because our tourism arm is powered by our proprietary tech infrastructure, we guarantee a frictionless experience from digital booking to final destination. For organizations, travel agencies, and corporate planners seeking a flawless logistical backbone, our infrastructure is designed to seamlessly elevate your next large-scale venture.
            </p>
            <div className="flex gap-8">
              <div>
                <p className="text-secondary font-headline font-bold text-2xl">42</p>
